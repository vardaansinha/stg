                ...
                .then(response => {
                    ...
                    response.json().then(teams => {
                        ...
                        for (let team in teams) {
                            ...
                            text += "<tr><td>" + teams[team].team + "</td><td>" + teams[team].division + "</td><td><div contenteditable>" + teams[team].gamesplayed + "</div></td><td><div contenteditable>" + teams[team].gameswon + "</div></td><td>" + teams[team].gameslost + "<div contenteditable></td><td>" + teams[team].gamesdrawn + "</div></td><td>" + teams[team].gamesplayedathome + "<div contenteditable></td><td>" + teams[team].gamesplayedaway + "</div></td><td>" + teams[team].gameswonathome + "<div contenteditable></td><td>" + teams[team].gameswonaway + "</div></td><td>" + teams[team].gameslostathome + "<div contenteditable></td><td>" + teams[team].gameslostaway + "</div></td><td>" + teams[team].pointsfor + "<div contenteditable></td><td>" + teams[team].pointsagainst + "</div></td><td>" + teams[team].playoffs + "<div contenteditable></td></tr>";
                        }
                        text += "</table>";
                        team1Select+= "</select>";
                        team2Select+= "</select>";
